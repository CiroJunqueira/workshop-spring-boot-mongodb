package com.ciro.workshopmongo.config;
...
import com.ciro.workshopmongo.config.DTO.AuthorDTO;
import com.ciro.workshopmongo.config.DTO.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1= new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou p Sao Paulo", new AuthorDTO(maria));
